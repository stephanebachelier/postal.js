...
function HTML(runner, root) {
  ...
  runner.on('spec end', function(test){
    ...
    if ('passed' == test.state) {
      ...
      var el = fragment('<li class="spec pass %e"><h2>%e<span class="duration">%ems</span> <a href="%s" class="replay">‣</a></h2></li>', test.speed, test.title, test.duration, url);
    } else if (test.pending) {
      var el = fragment('<li class="spec pass pending"><h2>%e</h2></li>', test.title);
    } else {
      var el = fragment('<li class="spec fail"><h2>%e <a href="?grep=%e" class="replay">‣</a></h2></li>', test.title, encodeURIComponent(test.fullTitle()));
